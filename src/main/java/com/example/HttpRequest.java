...
public class HttpRequest {
     ...
     * @param uri the target address to send the request to
     */
    public HttpRequest(HttpMethod httpMethod, String uri) throws URISyntaxException {
     ...
     */
    public HttpRequest(HttpMethod httpMethod, String uri, HttpHeaders headers, Flux<byte[]> body) throws URISyntaxException {
        this.httpMethod = httpMethod;
        this.uri = new URI(uri);
